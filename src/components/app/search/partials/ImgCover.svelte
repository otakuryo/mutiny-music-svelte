...
<img loading="lazy" src={imageUrl} on:error={handleError} data-amplitude-song-info="cover_art_url" class="w-{size} h-{size} rounded-sm border-bg-player-light-background dark:border-cover-dark-border object-cover {css}" alt={title}/>
